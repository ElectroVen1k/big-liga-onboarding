...
var pagePreview = document.querySelector('.preview');
var bodyElement = document.querySelector('body');
var infoCоntent = document.querySelector('.info');
var logoElement = document.querySelector('.preview__logo');
var windowDesktopSize = window.matchMedia('(max-width: 1023px)');
...
var onLoaderEnterPress = function onLoaderEnterPress(evt) {
  if (evt.key === 'Enter') {
    onRemovedLoader();
  }
};

var onScreenTouch = function onScreenTouch() {
  onRemovedLoader();
};

var onRemovedLoader = function onRemovedLoader() {
...
var onMainContentTouch = function onMainContentTouch() {
  if (windowDesktopSize.matches) {
...
var toggleAdditicalInfo = function toggleAdditicalInfo() {
...
var onLogoTouch = function onLogoTouch(evt) {
  evt.stopPropagation();
};
